...
class myParser:
    ...
    def set_arguments(self):
        self.parser.add_argument('--gpu', type=str, default='0, 1, 2, 3, 4')
        ...
        self.parser.add_argument('--n-workers', type=int, default=5)
        ...
        self.parser.add_argument('--mode', type=str, default='random_iid', choices=['ramdom_iid', 'pathological_pair'])
